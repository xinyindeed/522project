...
#petition by control
t.test(petition_control, petition_ID_only, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(petition_control, petition_emp_only, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(petition_control, petition_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

#petition by emp+ID
t.test(petition_ID_only, petition_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(petition_emp_only, petition_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)
...
#donation by control
t.test(donat_control, donat_ID_only, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(donat_control, donat_emp_only, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(donat_control, donat_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

#donation by emp+ID
t.test(donat_ID_only, donat_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)

t.test(donat_emp_only, donat_ID_and_Em, alternative = c("greater"), mu=0, paired=FALSE, var.equal = FALSE, conf.level = 0.95)
```
